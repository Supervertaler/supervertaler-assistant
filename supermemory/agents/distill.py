...
class DistillAgent:
    ...
    def __init__(self, llm: LlmClient, vault_dir: str | Path) -> None:
        ...
        self._prompt = _load_distill_prompt(self.vault_dir)
    ...
    def run(self, source_file: str | Path) -> DistillResult:
        ...
        try:
            ...
            result.error = (
                ...
                "Install with: pip install 'supermemory[distill]'"
            )
            return result
...
def _load_distill_prompt(vault_dir: Path) -> str:
    """Load distill.md, preferring the vault's copy over the bundled fallback.
    ...
    """
    user_template = vault_dir / "06_TEMPLATES" / "distill.md"
    ...
    return (
        ...
        "Markdown article ready for SuperMemory's inbox. Follow the "
        "frontmatter / structure conventions of the SuperMemory format."
    )
